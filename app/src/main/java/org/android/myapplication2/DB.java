...
public class DB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditTextName = (EditText)findViewById(R.id.editText_db_name);
        mEditTextAddress = (EditText)findViewById(R.id.editText_db_address);
        mTextViewResult = (TextView)findViewById(R.id.textView_db_result);

        Button buttonInsert = (Button)findViewById(R.id.button_db_insert);
    ...
    class InsertData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(DB.this,
